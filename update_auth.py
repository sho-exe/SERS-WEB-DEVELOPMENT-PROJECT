...
login_content = """<%@page contentType="text/html" pageEncoding="UTF-8"%>
<!DOCTYPE html>
...
logout_content = """<%@page contentType="text/html" pageEncoding="UTF-8" %>
<% 
    if (session != null) { 
        session.invalidate(); 
    } 
...
with open('web/Login.jsp', 'w') as f:
    f.write(login_content)

with open('web/Logout.jsp', 'w') as f:
