                                            ...
                                            <div class="card border-0 shadow-sm rounded-3">
                                                <div class="card-body p-4 border-start border-primary border-5">
                                                    ...
                                                    <h2 class="display-6 fw-bold text-primary">${totalMerits != null
                                                        ?
                                                        totalMerits : '0'}</h2>
                                                    <p class="mb-0 text-muted small">Updated by Admin HEPA</p>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="card border-0 shadow-sm rounded-3">
                                                <div class="card-body p-4 border-start border-success border-5">
                                                    <h6 class="text-muted text-uppercase small font-weight-bold">
                                                        Active
                                                        Registrations</h6>
                                                    <h2 class="display-6 fw-bold text-success">${activeRegCount !=
                                                        null
                                                        ? activeRegCount : '0'}</h2>
                                                    <p class="mb-0 text-muted small">Events you are currently joined
                                                        in
                                                    </p>
                                                </div>
                                            </div>
