                                                ...
                                                <% if ("STUDENT".equals(role)) { %>
                                                    ...
                                                    <% } else if ("ADVISOR".equals(role)) { %>
                                                        <li class="menu-item active">
                                                            <a href="Homepage_sneat.jsp" class="menu-link">
                                                                <i class="menu-icon tf-icons bx bx-home-circle"></i>
                                                                <div data-i18n="Advisor Dashboard">Advisor Dashboard
                                                                </div>
                                                            </a>
                                                        </li>
                                                        <li class="menu-item">
                                                        ...
                                                        <li class="menu-item">
                                                            <a href="events?action=pending" class="menu-link">
                                                                ...
                                                                <div data-i18n="Pending Approvals">Pending Approvals
                                                                </div>
                                                            </a>
                                                        </li>
                                                        <li class="menu-item">
                                                        ...
                                                        <% } else if ("CHAIRPERSON".equals(role)) { %>
                                                            ...
                                                            <li class="menu-item">
                                                                <a href="events?action=manage" class="menu-link">
                                                                    <i
                                                                        class="menu-icon tf-icons bx bx-calendar-plus"></i>
                                                            ...
                                                            <% } else if ("HEPA".equals(role)) { %>
                                                                ...
                                                                <li class="menu-item">
                                                                    <a href="merits?action=distributeMerits"
                                                                        ...
                                                                        <div data-i18n="Distribute Merits">Distribute
                                                                            Merits</div>
                                                                    </a>
                                                                </li>
                                                                <% } %>
                                                ...
                                                <div class="navbar-nav-right d-flex align-items-center"
                                                    ...
                                                    <div class="navbar-nav align-items-center">
                                                        <div class="nav-item d-flex align-items-center">
                                                            ...
                                                            <span
                                                                class="badge bg-label-primary ms-3">${accountType}</span>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="content-wrapper" style="padding: 0px 30px;">
                                                ...
                                                <div class=" flex-grow-1 container-p-y">
                                                    ...
                                                    <div class="alert alert-success border-0  bg-success-soft">
                                                        <i class="fas fa-info-circle me-2 text-success"></i> As an
